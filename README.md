...
**Lisp Machine Z makes MIT's Lisp Machine usable today:** on current hardware,
...
CADR". LMZ is forked from **System 100**, [LM-3](https://tumbleweed.nu/lm-3/)'s
...
LMZ is the system. Three projects provide the machine:
...
| `site/` | the site files a machine loads, for the example site `LMZ` |
