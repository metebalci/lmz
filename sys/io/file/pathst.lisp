...
;; LMZ: ITS support (ITS-PATHNAME-MIXIN, ITS-DEVICE-STRING,
;; ITS-FN2-STRING, SIX-SIXBIT-CHARACTERS) removed; LMZ never talks to an
...
  
;; LMZ: TENEX-family pathname support (TENEX-FAMILY-PATHNAME-MIXIN, the
;; shared base of TOPS-20, TENEX and VMS pathnames) and TOPS-20 support
;; (TOPS20-PATHNAME-MIXIN) removed; LMZ never talks to a TOPS-20 host.
...
;; LMZ: Tenex support (TENEX-PATHNAME-MIXIN) removed; LMZ never talks to
;; a Tenex host.

;; LMZ: VMS support (VMS-PATHNAME-MIXIN) removed; LMZ never talks to a VMS
;; file server.

;;;; Unix support
;; LMZ: Multics support (MULTICS-PATHNAME-MIXIN) removed; LMZ never talks to
...
;;; LMZ: the :STRING-FOR-DIRECTORY method was missing, so a Unix pathname
...
;; LMZ: ITS-PATHNAME went with ITS support; TOPS20-PATHNAME and
