...
;; LMZ: the Multics special case (never guess, since Multics would hassle the
...
;; LMZ: UNAME-HOST used to also be the symbol FS:ITS, when logging in to an
...
(DEFMETHOD (BASIC-ACCESS :DELETE-MULTIPLE-FILES) (ERROR-P FILES)
  ;; LMZ: the MAPCAR passed ERROR-P as a list, one element per file.
...
;; LMZ: FILE-HOST-ITS-MIXIN went with ITS support.
;; LMZ: FILE-HOST-TOPS20-MIXIN and FILE-HOST-TENEX-MIXIN went with TOPS-20
;; and Tenex support.
...
;; LMZ: ITS-HOST went with ITS support; TOPS20-HOST and TENEX-HOST went with
...
;; LMZ: MULTICS-HOST went with Multics support.
