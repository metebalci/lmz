...
(DEFSYSTEM SYSTEM-INTERNALS
  ...
  (:MODULE MAIN ("SYS: SYS2; ADVISE"
		 ...
		 "SYS: SYS; EVAL"
		 "SYS: SYS2; FLAVOR"
		 ;; LMZ: no SYS: SYS; FSPEC.  The whole file was one block comment
...
(DEFSYSTEM CHAOS
  ...
  (:MODULE AUX "CHSAUX")
  (:MODULE TEST "CHATST")
  ;; LMZ: no EFTP module.  EFTP spoke PUP to Xerox Altos and the Dover printer, and is deleted.
...
(DEFSYSTEM ZMAIL
  ...
  (:MODULE MAIN ("TOP" "MFILES" "MFHOST" "REFER" "SYS:FILE;ZMAIL"
...
(DEFCONST COLD-LOAD-FILE-LIST
	  '("SYS: FONTS; CPTFON QFASL >"
	    "SYS: SYS; QRAND QFASL >"
	    ;; LMZ: no SYS: SYS; FSPEC.  The whole file was one block comment, so
...
(DEFCONST MINI-FILE-ALIST-LIST
	  ;; LMZ: no ETHERNET-FILE-ALIST; only a Lambda loaded the Ethernet files.
