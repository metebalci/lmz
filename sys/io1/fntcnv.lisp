...
;	AC another xerox format.  LMZ: no longer supported; see below.
...
(DEFUN READ-KS-INTO-FONT-DESCRIPTOR (FILENAME &OPTIONAL FONTNAME
  ...
  FD))

;;; LMZ: AC files, the Xerox printers' font format, are no longer read or written.
;;; Their reader and writer called the PRESS package, which went with Dover printing.
