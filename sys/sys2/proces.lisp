...
;; LMZ: the commented-out PROCESS-CREATE alias was removed with its stale
...
;; LMZ: the CADR's length; the Lambda's is gone.
...
;;; LMZ: PROCESS-SCHEDULER-FOR-LAMBDA, this function's twin for the Lambda, is deleted.
