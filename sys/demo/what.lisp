...
(DEFVAR WHAT-PARSE-STRING-ALIST
	`(("is this" NIL "It's an all purpose utility program, dummy!")
	  ...
	  ("brand" NIL ,#'(LAMBDA () (FORMAT STANDARD-OUTPUT "Brand M")))	;LMZ: no #+SYMBOLICS answer
...
I'll give the garbage collector a fatal error before long.")
	  ;; LMZ: "me load patches" is gone with LOAD-PATCHES.
	  ("sys" T (:MAP . "system"))
	  ("newio" T (:MAP . "lisp"))
	  ("features" NIL ,#'(LAMBDA () (FORMAT:PRINT-LIST NIL "~S" *FEATURES*)))	;LMZ: was (STATUS FEATURE)
