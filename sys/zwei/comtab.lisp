...
;; LMZ: COMMAND-LOOKUP keys a list comtab by character objects (:35), so
...
;	    #/END COM-QUIT
	  ...
	  (MAKE-COMMAND-ALIST
	   '(;; COM*:
	     ...
	     ;; LMZ: no COM-VIEW-DOVER-QUEUE; Dover printing is gone (ZWEI; COMH).
	     COM-VIEW-MAIL
  ...
  (SETQ *STANDARD-CONTROL-X-COMTAB*
	(SET-COMTAB 'STANDARD-CONTROL-X-COMTAB
		    '(#/C-G COM-PREFIX-BEEP
		      ...
		      #/X COM-PUT-REGISTER
		;; LMZ: six command names here named no DEFCOM at all; the real ones are
