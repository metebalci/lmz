...
;;; LMZ: the bring-up asked whether these are still used.  :PRIMARY-DEVICE is:
...
;; LMZ: the :MULTICS mixin (HOST-MULTICS-MIXIN) went with Multics support;
;; LMZ never talks to a Multics host.
...
;; LMZ: the :VMS mixin (HOST-VMS-MIXIN) went with VMS support; LMZ never
;; talks to a VMS host.
